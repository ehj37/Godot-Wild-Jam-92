...
const CUSTOMER_TYPE_TO_CAULDRON_WATER_FEEDBACK: Dictionary = {
	Customer.CustomerType.FRANK: _FRANK_CAULDRON_WATER_FEEDBACK,
	Customer.CustomerType.SKELLY: _SKELLY_CAULDRON_WATER_FEEDBACK,
	Customer.CustomerType.PHANTOM: _PHANTOM_CAULDRON_WATER_FEEDBACK
}
...
const _FRANK_CAULDRON_WATER_FEEDBACK: String = "DISGUSTING"
const _SKELLY_CAULDRON_WATER_FEEDBACK: String = "I'M GONNA BE SICK"
const _PHANTOM_CAULDRON_WATER_FEEDBACK: String = "GROOOOSSSSS"
